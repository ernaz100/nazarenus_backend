...
from priorMDM.diffusion.nn import mean_flat, sum_flat
from priorMDM.diffusion.losses import normal_kl, discretized_gaussian_log_likelihood
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        """
        # df: we have to convert the t tensor to a long
        t = t.to(torch.long)
