...
from priorMDM.model.smpl import SMPL, JOINTSTYPE_ROOT
...
class Rotation2xyz:
    def __init__(self, device, dataset='amass', batch_size=None):
        ...
        if dataset == 'babel':
            self.smpl_model = SMPLH(path='../diffusion_motion_inbetweening/body_models/smpl',
                                                  jointstype='smplnh',
            ...
            self.smpl_model = SMPL(path='../diffusion_motion_inbetweening/body_models/smpl').eval().to(device)
